...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final List<String>? tags; // Menambahkan tanda tanya untuk null safety
  final Function(String)?
      getCurrentPage; // Mengubah tipe menjadi Function(String)?
  final bool isOnSearch;
  final TextEditingController?
      searchController; // Menambahkan tanda tanya untuk null safety
  final Function(String)?
      searchOnChanged; // Mengubah tipe menjadi Function(String)?
  ...
  final double _preferredHeight =
      200.0; // Memperbaiki typo dari _prefferedHeight
...
class _NavbarState extends State<Navbar> {
  String? activeTag; // Menambahkan tanda tanya untuk null safety
  ...
  void initState() {
    ...
    if (widget.tags != null && widget.tags!.isNotEmpty) {
      activeTag = widget.tags![0]; // Menggunakan ! untuk mengakses nilai
    }
  }
              ...
              if (categories)
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, '/AllTiket');
                      },
                      child: Row(
                        children: [
                    ...
                    SizedBox(width: 30),
                    Container(color: ArgonColors.initial, height: 25, width: 1),
                    SizedBox(width: 30),
                    GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, '/AddTiket');
                      },
                      child: Row(
                        children: [
